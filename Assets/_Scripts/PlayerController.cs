...
public class PlayerController : MonoBehaviour
{
    ...
    //reference to the BulletPoolManager
    ...
    { 
        while (true)
        {
            ...
            if (isFiring)
            {
                ...
                // Uses the BulletPoolManager's GetBullet function 
                // which returns a reference to a bullet object 
                // and positions the new bullet at the bulletSpawn position
                GameObject activeBullet = BulletPoolManager.instance.GetBullet();
                activeBullet.transform.position = bulletSpawn.position;
            }
